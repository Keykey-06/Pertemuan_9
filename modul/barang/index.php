                ...
                <form action="modul/barang/proses.php?aksi=tambah" method="post">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_barang" class="form-control" placeholder="Contoh : Buku" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="merk">Merk</label>
                            <input type="text" name="merk" class="form-control" placeholder="Contoh : Joyko" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="ukuran">Ukuran</label>
                            <input type="text" name="ukuran" class="form-control" placeholder="Contoh : Besar" required>
                        </div>
                        <div class="mb-3">
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="modal fade" id="modalEdit<?= $row_barang['id_barang'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="mb-3">
                            <label class="form-label" for="nama_barang">Nama Barang</label>
                            <input type="text" name="nama_barang" class="form-control" placeholder="Contoh : Buku" value="<?= $row_barang['nama_barang'];?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="merk">Merk</label>
                            <input type="text" name="merk" class="form-control" placeholder="Contoh : Joyko" value="<?= $row_barang['merk'];?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="ukuran">Ukuran</label>
                            <input type="text" name="ukuran" class="form-control" placeholder="Contoh : Besar" value="<?= $row_barang['ukuran'];?>" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="satuan">Satuan</label>
